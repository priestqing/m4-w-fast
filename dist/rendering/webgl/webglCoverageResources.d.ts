...
/** 管理 WebGL 边界网格、模板覆盖和遮罩纹理。 */
export declare class WebglCoverageResources {
    private readonly gl;
    private readonly program;
    private readonly coordinateLocation;
    ...
    private width;
    private height;
    constructor(gl: WebGLRenderingContext, crs: MapCrs, createProgram: (vertex: string, fragment: string) => WebGLProgram);
